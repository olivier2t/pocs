...
Build and deploy a Node.js web application on an VMware Virtual Machine.

This stack will create a VMware Virtual Machine and deploy the Web application via cloud-init.
